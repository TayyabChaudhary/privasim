...
export const CodeBlock: React.FC<Props> = ({ code }) => {
  ...
  return (
    <pre>
  <div className="bg-white-100 rounded-md mb-4">
    <div className="flex items-center relative text-black-200 bg-gray-200 px-4 py-2 text-xs font-sans justify-between rounded-t-md">
      <div className="flex">
        <span>mermaid</span>
        <HoverCard>
          <HoverCardTrigger>
    ...
    <div className="p-4 overflow-y-auto">
      <code className="!whitespace-pre text-black hidden">{code}</code>
    </div>
  </div>
</pre> 
  );
